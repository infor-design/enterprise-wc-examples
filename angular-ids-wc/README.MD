...
2. Add `skipLibCheck` so that the types in the node_modules are not checked independently. https://github.com/infor-design/enterprise-wc-examples/blob/main/angular-ids-wc/tsconfig.json#L18
