...
@Component({
  selector: 'app-ids-lookup-example',
  templateUrl: './ids-lookup-example.component.html',
  styleUrls: ['./ids-lookup-example.component.css']
})
export class IdsLookupExampleComponent implements AfterViewInit {
