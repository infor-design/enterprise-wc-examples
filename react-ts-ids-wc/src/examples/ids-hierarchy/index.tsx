    ...
    <>
      ...
      <ids-layout-grid auto-fit="true" padding="md">
        <ids-layout-grid-cell>
          ...
          <ids-hierarchy>
            <ids-hierarchy-item id="item-1" root-item expanded color="blue-80">
              ...
              <ids-hierarchy-item id="item-2" color="purple-20">
              ...
              <ids-hierarchy-item id="item-3" color="purple-60">
                ...
                <ids-hierarchy-item id="item-4" color="gray-60">
                  <ids-text slot="heading">Julie Dawes</ids-text>
                  <ids-text slot="subheading">Records Clerk</ids-text>
                  <ids-text slot="micro">OP</ids-text>

                  <ids-hierarchy-item id="item-5" color="purple-60">
                    <ids-text slot="heading">Tony Cleveland</ids-text>
                    <ids-text slot="subheading">Director</ids-text>
                    <ids-text slot="micro">C</ids-text>
                  </ids-hierarchy-item>
