...
const IdsDropdown = () => {
  const dropdownAsyncRef = useRef<IdsDropdownType>();

  useEffect(() => {
    const dropdownAsync = dropdownAsyncRef.current;
    ...
    <>
      ...
      <ids-layout-grid auto-fit="true">
        <ids-layout-grid-cell>
          ...
          <ids-dropdown readonly="true" label="Readonly Dropdown" value="opt3">
            <ids-list-box>
              <ids-list-box-option value="opt1" id="opt1-d2">
                Option One
              </ids-list-box-option>
              <ids-list-box-option value="opt2" id="opt2-d2">
                Option Two
              </ids-list-box-option>
              <ids-list-box-option value="opt3" id="opt3-d2">
                Option Three
              </ids-list-box-option>
              <ids-list-box-option value="opt4" id="opt4-d2">
                Option Four
              </ids-list-box-option>
              <ids-list-box-option value="opt5" id="opt5-d2">
                Option Five
              </ids-list-box-option>
              <ids-list-box-option value="opt6" id="opt6-d2">
                Option Six
              </ids-list-box-option>
            </ids-list-box>
          </ids-dropdown>
          ...
          <ids-dropdown id="dropdown-3" disabled="true" label="Disabled Dropdown" value="opt4">
            <ids-list-box>
              <ids-list-box-option value="opt1" id="opt1-d3">
                Option One
              </ids-list-box-option>
              <ids-list-box-option value="opt2" id="opt2-d3">
                Option Two
              </ids-list-box-option>
              <ids-list-box-option value="opt3" id="opt3-d3">
                Option Three
              </ids-list-box-option>
              <ids-list-box-option value="opt4" id="opt4-d3">
                Option Four
              </ids-list-box-option>
              <ids-list-box-option value="opt5" id="opt5-d3">
                Option Five
              </ids-list-box-option>
              <ids-list-box-option value="opt6" id="opt6-d3">
                Option Six
              </ids-list-box-option>
            </ids-list-box>
          </ids-dropdown>

          <ids-dropdown label="Required Dropdown" value="opt1" validate="required">
            <ids-list-box>
              <ids-list-box-option value="blank" id="blank" aria-label="Blank"></ids-list-box-option>
              <ids-list-box-option value="opt1" id="opt1-d4">
                Option One
              </ids-list-box-option>
              <ids-list-box-option value="opt2" id="opt2-d4">
                Option Two
              </ids-list-box-option>
              <ids-list-box-option value="opt3" id="opt3-d4">
                Option Three
              </ids-list-box-option>
              <ids-list-box-option value="opt4" id="opt4-d4">
                Option Four
              </ids-list-box-option>
              <ids-list-box-option value="opt5" id="opt5-d4">
                Option Five
              </ids-list-box-option>
              <ids-list-box-option value="opt6" id="opt6-d4">
                Option Six
              </ids-list-box-option>
            </ids-list-box>
          </ids-dropdown>
          ...
          <ids-dropdown label="Dropdown with Tooltips" tooltip="Additional Info" value="opt2">
            <ids-list-box>
              <ids-list-box-option value="opt1" id="opt1-d6" tooltip="Additional Info on Option One">
                Option One
              </ids-list-box-option>
              <ids-list-box-option value="opt2" id="opt2-d6" tooltip="Additional Info on Option Two">
                Option Two
              </ids-list-box-option>
              <ids-list-box-option value="opt3" id="opt3-d6" tooltip="Additional Info on Option Three">
                Option Three
              </ids-list-box-option>
              <ids-list-box-option value="opt4" id="opt4-d6" tooltip="Additional Info on Option Four">
                Option Four
              </ids-list-box-option>
              <ids-list-box-option value="opt5" id="opt5-d6" tooltip="Additional Info on Option Five">
                Option Five
              </ids-list-box-option>
              <ids-list-box-option value="opt6" id="opt6-d6" tooltip="Additional Info on Option Six">
                Option Six
              </ids-list-box-option>
            </ids-list-box>
          </ids-dropdown>

          <ids-dropdown ref={dropdownAsyncRef} label="Dropdown Using Ajax" value="ak">
            <ids-list-box>
              <ids-list-box-option value="ak">Alaska</ids-list-box-option>
            </ids-list-box>
          </ids-dropdown>

          <ids-dropdown label="Dropdown with Allow Blank" allow-blank>
            <ids-list-box>
