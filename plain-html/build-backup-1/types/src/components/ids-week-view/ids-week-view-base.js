...
const Base = IdsThemeMixin(IdsDateAttributeMixin(IdsCalendarEventsMixin(IdsLocaleMixin(IdsEventsMixin(IdsElement)))));
export default Base;
//# sourceMappingURL=ids-week-view-base.js.map