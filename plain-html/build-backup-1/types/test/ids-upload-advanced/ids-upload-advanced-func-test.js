...
describe('IdsUploadAdvanced Component', () => {
    ...
    it('should change event on file input', () => {
        ...
        const args = { bubbles: true, files: [file] };
    ...
    it('should drag drop', () => {
        ...
        el.disabled = true;
        el.droparea.dispatchEvent(createBubbledEvent('dragenter', { dataTransfer: { files } }));
        el.droparea.dispatchEvent(createBubbledEvent('drop', { dataTransfer: { files } }));
        el.disabled = false;
        el.droparea.dispatchEvent(createBubbledEvent('dragenter', { dataTransfer: { files } }));
        el.droparea.dispatchEvent(createBubbledEvent('dragover', { dataTransfer: { files } }));
        el.droparea.dispatchEvent(createBubbledEvent('drop', { dataTransfer: { files } }));
        document.dispatchEvent(createBubbledEvent('dragenter', { dataTransfer: { files } }));
        document.dispatchEvent(createBubbledEvent('dragover', { dataTransfer: { files } }));
        document.dispatchEvent(createBubbledEvent('drop', { dataTransfer: { files } }));
        const fileElems = el.shadowRoot.querySelectorAll('ids-upload-advanced-file');
        expect(fileElems.length).toEqual(1);
    });
    ...
    it('should manually start upload all files', async () => {
        ...
        el.autoStart = false;
        let toolbararea = el.shadowRoot.querySelector('.toolbararea');
        ...
        toolbar.items.filter((btn) => btn.id === 'btn-start-all')[0].click();
        fileElems.forEach((elem) => {
            expect(elem.status).toEqual('in-process');
        });
    ...
    it('should cancel upload all files', () => {
        ...
        toolbar.items.filter((btn) => btn.id === 'btn-cancel-all')[0].click();
        fileElems = el.shadowRoot.querySelectorAll('ids-upload-advanced-file');
...
//# sourceMappingURL=ids-upload-advanced-func-test.js.map