...
import type { IdsRangeSettings, IdsRangeSettingsInterface, IdsLegendSettings, IdsDisableSettings } from '../ids-month-view/ids-month-view-common';
...
declare const Base: {
    new (...args: any[]): {
        ...
        getLegendByDate(date: Date): import("../ids-month-view/ids-month-view-common").IdsLegend | undefined;
 ...
 */
declare class IdsDatePickerPopup extends Base implements IdsRangeSettingsInterface {
    #private;
    constructor();
     ...
     */
    get buttons(): NodeListOf<IdsDatePickerPopupButton> | undefined;
    /**
    ...
    onDisableSettingsChange(val: IdsDisableSettings): void;
     ...
     */
    setRangeSettings(val: IdsRangeSettings): void;
    ...
    onUseRangeChange(val: boolean): void;
    /**
     * value attribute
     ...
     */
    private handleDaySelectedEvent;
    /**
     ...
     */
    syncDateAttributes(val: string | Date): void;
     ...
     * @returns {void}
     */
    updateMonthYearPickerTriggerDisplay(locale?: IdsLocale, date?: Date): void;
    /**
     ...
     */
    isDisabledByDate(date: Date): boolean | undefined;
    /**
