...
const Base = IdsFocusCaptureMixin(IdsPopupOpenEventsMixin(IdsPopupInteractionsMixin(IdsEventsMixin(IdsAttachmentMixin(IdsElement)))));
export default Base;
//# sourceMappingURL=ids-picker-popup-base.js.map