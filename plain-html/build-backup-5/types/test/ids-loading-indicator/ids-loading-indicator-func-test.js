...
describe('IdsLoadingIndicator Component', () => {
    ...
    it('sets and gets the inline attribute reliably', async () => {
        elem = await createElemViaTemplate('<ids-loading-indicator inline></ids-loading-indicator>');
    ...
    it('sets and gets the percentage-visible attribute reliably', async () => {
        elem = await createElemViaTemplate('<ids-loading-indicator sticky percentage-visible></ids-loading-indicator>');
...
//# sourceMappingURL=ids-loading-indicator-func-test.js.map