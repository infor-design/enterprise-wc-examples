 ...
 */
let IdsDraggable = class IdsDraggable extends Base {
    #relativeBounds = {};
    constructor() {
        super();
    }
    ...
    onMouseMove = (e) => {
        ...
        if (this.isDragging) {
            ...
            const [translateX, translateY] = this.#updateTransform(dragDeltaX, dragDeltaY);
            if (this.#parentRect) {
...
IdsDraggable = __decorate([
    customElement('ids-draggable'),
    scss(styles),
    __metadata("design:paramtypes", [])
], IdsDraggable);
export default IdsDraggable;
//# sourceMappingURL=ids-draggable.js.map