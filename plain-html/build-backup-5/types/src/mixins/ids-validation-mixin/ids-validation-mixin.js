...
const IdsValidationMixin = (superclass) => class extends superclass {
     ...
     */
    addMessage(settings) {
        const { id, type, message, icon } = settings;
        const thisAsInput = this;
        if (!id)
            return;
     ...
     */
    get isValid() { return this.shadowRoot?.querySelectorAll('.validation-message').length === 0; }
    /**
...
//# sourceMappingURL=ids-validation-mixin.js.map