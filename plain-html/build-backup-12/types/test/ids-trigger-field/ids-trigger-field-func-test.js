...
const DEFAULT_TRIGGERFIELD_HTML = (`<ids-trigger-field
      id="trigger-field-1"
      size="sm"
      tabbable="false"
      label="Date Field"
  ...
  `);
const REQUIRED_TRIGGERFIELD_HTML = (`<ids-trigger-field
      id="trigger-field-1"
      size="sm"
      tabbable="false"
      label="Date Field"
  ...
  `);
const TWO_BUTTON_TRIGGERFIELD_HTML = (`<ids-trigger-field
      id="trigger-field-1"
      size="sm"
      tabbable="false"
...
//# sourceMappingURL=ids-trigger-field-func-test.js.map