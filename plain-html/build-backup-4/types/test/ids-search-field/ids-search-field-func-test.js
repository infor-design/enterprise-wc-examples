...
const HTMLSnippets = {
    VANILLA_SEARCH_FIELD: (`<ids-search-field></ids-search-field>`),
    DISABLED_SEARCH_FIELD: (`<ids-search-field disabled label="Pokemon" value="Snorlax"></ids-search-field>`),
    READONLY_SEARCH_FIELD: (`<ids-search-field readonly label="Pokemon" value="Lapras"></ids-search-field>`)
};
describe('IdsSearchField Component', () => {
    ...
    it('listens for input events', () => {
        s.input.dispatchEvent(createEvent('input'));
    });
    it('listens for keydown events', () => {
        s.input.dispatchEvent(createKeyboardEvent('Enter'));
        s.input.dispatchEvent(createKeyboardEvent('Space'));
    });
...
//# sourceMappingURL=ids-search-field-func-test.js.map