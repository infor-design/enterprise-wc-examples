...
const Base = IdsXssMixin(IdsBreakpointMixin(IdsFocusCaptureMixin(IdsKeyboardMixin(IdsPopupInteractionsMixin(IdsPopupOpenEventsMixin(IdsThemeMixin(IdsEventsMixin(IdsElement))))))));
export default Base;
//# sourceMappingURL=ids-modal-base.js.map