...
import { getClosest, getClosestRootNode, getEditableRect, waitForTransitionEnd, } from '../../utils/ids-dom-utils/ids-dom-utils';
 ...
 */
let IdsPopup = class IdsPopup extends Base {
    shouldUpdate = false;
    isFlipped = false;
    constructor() {
        super();
