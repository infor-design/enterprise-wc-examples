...
describe('IdsLineChart Component', () => {
    ...
    it('should get/set selected by api', async () => {
        ...
        let selected = lineChart.selectionElements.filter((el) => el.hasAttribute('selected'));
        let selectedClass = lineChart.selectionElements.filter((el) => el.classList.contains('selected'));
        ...
        expect(lineChart.getSelected()).toEqual({});
        selected = lineChart.selectionElements.filter((el) => el.hasAttribute('selected'));
        selectedClass = lineChart.selectionElements.filter((el) => el.classList.contains('selected'));
        expect(selected.length).toEqual(0);
        expect(selectedClass.length).toEqual(0);
        expect(lineChart.getSelected()).toEqual({});
...
//# sourceMappingURL=ids-line-chart-func-test.js.map