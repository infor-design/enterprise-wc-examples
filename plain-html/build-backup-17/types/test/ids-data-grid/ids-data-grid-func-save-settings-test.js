...
describe('IdsDataGrid Component Save Settings Tests', () => {
    ...
    it('should save/restore sort order to local storage', () => {
        ...
        expect(dataGrid.savedSetting(setting)).toEqual(expect.objectContaining({
            id: 'description',
            ascending: true
        }));
        document.body.innerHTML = '';
    ...
    it('should save all user settings to local storage', () => {
        expect(dataGrid.savedAllSettings()).toEqual(expect.objectContaining({
            activePage: null,
            columns: null,
            filter: null,
            pageSize: null,
    ...
    it('should save on pager change', async () => {
        ...
        await wait(10);
        expect(await dataGrid.savedAllSettings()).toEqual(expect.objectContaining({
            activePage: null,
            columns: null,
            filter: null,
            pageSize: null,
...
//# sourceMappingURL=ids-data-grid-func-save-settings-test.js.map