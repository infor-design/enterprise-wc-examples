...
const HTMLSnippets = {
    NAV_BUTTONS_WITHOUT_NESTING: (`<ids-pager page-size="20" page-number="10" total="200">
    ...
    NAV_BUTTONS_WITH_TOOLTIPS: (`<ids-pager page-size="20" page-number="10" total="200">
    ...
    NAV_BUTTONS_AND_INPUT: (`<ids-pager page-size="20" page-number="10" total="200">
      <section>
        <ids-pager-button first></ids-pager-button>
        <ids-pager-button previous></ids-pager-button>
        <ids-pager-input></ids-pager-input>
    ...
    NUMBER_LIST: (`<ids-pager type="list" step="0" page-size="20" page-number="10" total="500">
    </ids-pager>`),
    NUMBER_LIST_NAV: (`<ids-pager page-size="20" page-number="10" total="150">
      <section>
        <ids-pager-button previous></ids-pager-button>
    ...
    RIGHT_ALIGNED_CONTENT: (`<ids-pager page-size="20" page-number="10" total="150">
      <section>
        <ids-pager-button previous></ids-pager-button>
        <ids-pager-number-list></ids-pager-number-list>
        <ids-pager-button next></ids-pager-button>
    ...
    DOUBLE_SIDED_CONTENT: (`<ids-pager page-size="20" page-number="10" total="150">
      <section slot="start">
    ...
    DROPDOWN_CONTENT: (`<ids-pager page-number="1" page-size="10" total="200" id="ids-pager-example">
...
describe('IdsPager Component', () => {
    ...
    it('shows tooltip-popup when IdsPagerButton.tooltip is not empty', async () => {
        ...
        let tooltipElement = document.querySelector('ids-tooltip');
        expect(tooltipElement).toBeFalsy();
        first.showTooltip();
        tooltipElement = document.querySelector('ids-tooltip');
    ...
    it('can set disabled on ids-pager predictably', async () => {
        elem = await createElemViaTemplate('<ids-pager page-number="1" page-size="10" total="100" disabled></ids-pager>');
    ...
    it('creates a an ids-pager-button with "first" flag set and nav-disabled works reliably', async () => {
        elem = await createElemViaTemplate('<ids-pager-button page-number="1" page-size="10" total="100" first></ids-pager-button>');
        await processAnimFrame();
    ...
    it('can set parent-disabled on ids-pager-button predictably', async () => {
        elem = await createElemViaTemplate('<ids-pager-button page-number="1" page-size="10" total="100" parent-disabled></ids-pager-button>');
    ...
    it('sets pageNumber to NaN on ids-pager-button and pageNumber resets to 1', async () => {
        elem = await createElemViaTemplate('<ids-pager-button page-number="z" page-size="10" total="100" parent-disabled></ids-pager-button>');
        expect(elem.pageNumber).toEqual(1);
    });
    ...
    it('creates a an ids-pager-button with "previous" flag set and nav-disabled works reliably', async () => {
        elem = await createElemViaTemplate('<ids-pager-button page-number="1" page-size="10" total="100" previous></ids-pager-button>');
        await processAnimFrame();
        expect(elem.hasAttribute('nav-disabled')).toBeTruthy();
        elem.setAttribute('page-number', 5);
        await processAnimFrame();
    ...
    it('creates a an ids-pager-button with "next" flag set and nav-disabled works reliably', async () => {
        elem = await createElemViaTemplate('<ids-pager-button page-number="10" page-size="10" total="100" next></ids-pager-button>');
        await processAnimFrame();
        expect(elem.hasAttribute('nav-disabled')).toBeTruthy();
        elem.setAttribute('page-number', 5);
        await processAnimFrame();
    ...
    it('sets "last" flag on ids-pager-button and nav-disabled works reliably', async () => {
        elem = await createElemViaTemplate('<ids-pager-button page-number="10" page-size="10" total="100" last></ids-pager-button>');
        await processAnimFrame();
        expect(elem.hasAttribute('nav-disabled')).toBeTruthy();
        elem.setAttribute('page-number', 5);
        await processAnimFrame();
    ...
    it('creates ids-pager-button(s) and clicking causes no issues reliably', async () => {
        ...
        elem = await createElemViaTemplate('<ids-pager-button page-number="3" page-size="10" total="100" first></ids-pager-button>');
        ...
        elem = await createElemViaTemplate('<ids-pager-button page-number="2" page-size="10" total="100" previous></ids-pager-button>');
        elem.addEventListener('pagenumberchange', pageNumberChangeListener);
        ...
        pageNumberChangeListener = jest.fn();
        elem = await createElemViaTemplate('<ids-pager-button page-number="1" page-size="10" total="100" next></ids-pager-button>');
        elem.addEventListener('pagenumberchange', pageNumberChangeListener);
        ...
        pageNumberChangeListener = jest.fn();
        elem = await createElemViaTemplate('<ids-pager-button page-number="1" page-size="10" total="100" last></ids-pager-button>');
        elem.addEventListener('pagenumberchange', pageNumberChangeListener);
        ...
        // dispatch events
        elem = await createElemViaTemplate('<ids-pager-button page-number="3" page-size="10" total="100" first disabled></ids-pager-button>');
        elem.addEventListener('pagenumberchange', pageNumberChangeListener);
    ...
    it('creates ids-pager-number-list and it has the correct number of entries based on page size and total', async () => {
        const pageSize = 10;
        const total = 100;
        elem = await createElemViaTemplate(`<ids-pager-number-list page-number="10" page-size="${pageSize}" total="${total}" last></ids-pager-number-list>`);
    ...
    it('should fire event when clicked on number list button', async () => {
        const pageSize = 10;
        const total = 100;
        const el = await createElemViaTemplate(`<ids-pager-number-list page-number="10" step="-1" page-size="${pageSize}" total="${total}"></ids-pager-number-list>`);
    ...
    it('creates an ids-pager-input and pageSize can be set and read predictably', async () => {
        elem = await createElemViaTemplate(`<ids-pager-input page-number="10" page-size="2" total="100" last></ids-pager-input>`);
    ...
    it('creates a disabled ids-pager-button and parent-disabled can be set and read predictably', async () => {
        elem = await createElemViaTemplate(`<ids-pager-button page-number="10" page-size="2" total="100" disabled></ids-pager-button>`);
        expect(elem.disabled).toEqual(true);
    });
    it('registers an pagenumberchange event predictably on ids-pager-input changes', async () => {
        elem = await createElemViaTemplate(`<ids-pager-input page-number="10" page-size="2" total="100" first></ids-pager-input>`);
        let pageNumberChangeListener = jest.fn();
        elem.addEventListener('pagenumberchange', pageNumberChangeListener);
    ...
    it('creates an ids-pager-input and before value is assigned to total, has null calculated pageCount', async () => {
        elem = await createElemViaTemplate(`<ids-pager-input page-number="10" page-size="2" first></ids-pager-input>`);
    ...
    it('sets pageNumber on ids-pager-input to non-numeric value and gets page-number reset to 1', async () => {
        elem = await createElemViaTemplate(`<ids-pager-input page-number="1" page-size="2" total="100" first></ids-pager-input>`);
        elem.pageNumber = 'z22';
        expect(elem.pageNumber).toEqual(1);
    });
    ...
    it('predictably handles the disabled attribute on ids-pager-input', async () => {
        elem = await createElemViaTemplate('<ids-pager-input page-number="1" page-size="10" total="100" disabled></ids-pager-input>');
        expect(elem.disabled).toEqual(true);
        elem.setAttribute('disabled', false);
        expect(elem.disabled).toEqual(false);
        elem.setAttribute('disabled', true);
    ...
    it('predictably handles the parent-disabled attribute on ids-pager-input', async () => {
        elem = await createElemViaTemplate('<ids-pager-input page-number="1" page-size="10" total="100" parent-disabled></ids-pager-input>');
        expect(elem.parentDisabled).toEqual(true);
        elem.setAttribute('parent-disabled', false);
        expect(elem.parentDisabled).toEqual(false);
        elem.setAttribute('parent-disabled', true);
    ...
    it('it sets the pageSize on ids-pager-number-list to non numeric and it is reset to default', async () => {
        elem = await createElemViaTemplate(`<ids-pager-number-list page-number="1" page-size="z2z" total="100" first></ids-pager-number-list>`);
        expect(elem.pageSize).toEqual(10);
    });
    it('it sets the pageNumber on ids-pager-number-list to invalid sizes and it is reset to 1', async () => {
        elem = await createElemViaTemplate(`<ids-pager-number-list page-number="zz" page-size="2" total="100" first></ids-pager-number-list>`);
        expect(elem.pageNumber).toEqual(1);
        elem.pageNumber = -1;
        expect(elem.pageNumber).toEqual(1);
    });
    it('it sets the total on ids-pager-number-list to invalid sizes and it is reset to 1', async () => {
        elem = await createElemViaTemplate(`<ids-pager-number-list page-number="1" page-size="2" total="z2z" first></ids-pager-number-list>`);
        expect(elem.total).toEqual(1);
        elem.total = -1;
        expect(elem.total).toEqual(1);
    });
    it('sets disabled predictably on ids-pager-number-list', async () => {
        elem = await createElemViaTemplate(`<ids-pager-number-list page-number="10" page-size="2" total="100"></ids-pager-number-list>`);
        expect(elem.disabled).toEqual(false);
        ...
        expect(elem.disabled).toEqual(false);
        expect(elem.hasAttribute('disabled')).toEqual(false);
        elem = await createElemViaTemplate(`<ids-pager-number-list page-number="10" page-size="2" total="100" disabled></ids-pager-number-list>`);
        elem.disabled = true;
    });
...
//# sourceMappingURL=ids-pager-func-test.js.map