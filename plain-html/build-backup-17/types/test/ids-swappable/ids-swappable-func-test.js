...
const HTMLSnippets = {
    SWAPPABLE_COMPONENT: (`<ids-swappable id="swappable-1" selection="multiple">
      <ids-swappable-item></ids-swappable-item>
      <ids-swappable-item></ids-swappable-item>
      <ids-swappable-item></ids-swappable-item>
      <ids-swappable-item></ids-swappable-item>
    </ids-swappable>`),
    SWAPPABLE_COMPONENT_2: (`<ids-swappable id="swappable-2">
      <ids-swappable-item></ids-swappable-item>
      <ids-swappable-item></ids-swappable-item>
      <ids-swappable-item></ids-swappable-item>
      <ids-swappable-item></ids-swappable-item>
...
describe('IdsSwappable Component', () => {
    ...
    it('can get drag and drop items', async () => {
        ...
        idsSwappable.dispatchEvent(createBubbledEvent('dragstart', {}));
        startingItem.dispatchEvent(createBubbledEvent('dragstart', { selected: true }));
        endingItem.dispatchEvent(createBubbledEvent('dragend', {}));
        startingItem.dispatchEvent(createBubbledEvent('drag', { selected: true }));
        idsSwappable.dispatchEvent(createBubbledEvent('dragover', {}));
        endingItem.dispatchEvent(createBubbledEvent('dragover', {}));
        idsSwappable.dispatchEvent(createBubbledEvent('drop', {}));
        endingItem.dispatchEvent(createBubbledEvent('drop', {}));
        idsSwappable.dispatchEvent(createBubbledEvent('dragleave', {}));
        startingItem.dispatchEvent(createBubbledEvent('dragleave', {}));
        endingItem.dispatchEvent(createBubbledEvent('dragend', {}));
    });
...
//# sourceMappingURL=ids-swappable-func-test.js.map