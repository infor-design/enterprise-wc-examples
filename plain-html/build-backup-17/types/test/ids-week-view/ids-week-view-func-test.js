...
import { addDate, firstDayOfWeekDate, lastDayOfWeekDate } from '../../src/utils/ids-date-utils/ids-date-utils';
...
describe('IdsWeekView Component initialization', () => {
    ...
    it('can render via document.createElement (append early)', () => {
        const component = document.createElement('ids-week-view');
...
//# sourceMappingURL=ids-week-view-func-test.js.map