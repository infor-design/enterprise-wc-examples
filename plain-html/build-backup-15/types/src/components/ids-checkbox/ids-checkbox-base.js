...
const Base = IdsDirtyTrackerMixin(IdsLabelStateMixin(IdsValidationMixin(IdsHitboxMixin(IdsThemeMixin(IdsLocaleMixin(IdsEventsMixin(IdsElement)))))));
export default Base;
//# sourceMappingURL=ids-checkbox-base.js.map