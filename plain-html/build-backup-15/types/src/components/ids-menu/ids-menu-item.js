...
import { MENU_ITEM_SIZE, MENU_DEFAULTS, safeForAttribute } from './ids-menu-attributes';
 ...
 */
let IdsMenuItem = class IdsMenuItem extends Base {
    shouldUpdate = true;
    /**
     * Build the menu item
     */
...
IdsMenuItem = __decorate([
    customElement('ids-menu-item'),
    scss(styles),
    __metadata("design:paramtypes", [])
], IdsMenuItem);
export default IdsMenuItem;
//# sourceMappingURL=ids-menu-item.js.map