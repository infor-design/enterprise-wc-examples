 ...
 */
declare const IdsDataGridSaveSettingsMixin: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
         ...
         * @returns {void}
         */
        "__#132@#setBoolAttribute"(attributeName: string, value: boolean | string): void;
        /**
        ...
        handledEvents: Map<any, any>; /** Set the sort order */
        name?: string | undefined;
        state: Record<string, any>;
        cachedNonce: string;
        container?: HTMLElement | null | undefined;
        hasStyles: boolean; /** Set the active page number */
        args?: {
