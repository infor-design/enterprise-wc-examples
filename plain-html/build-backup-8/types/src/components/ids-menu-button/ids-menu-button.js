 ...
 * @inherits IdsButton
 */
let IdsMenuButton = class IdsMenuButton extends Base {
    constructor() {
        super();
    }
    /**
    ...
    set displaySelectedText(val) {
        ...
        if (bool)
            this.setAttribute(attributes.DISPLAY_SELECTED_TEXT, `${val}`);
        else
            this.removeAttribute(attributes.DISPLAY_SELECTED_TEXT);
        this.configureMenu();
    }
    /**
...
IdsMenuButton = __decorate([
    customElement('ids-menu-button'),
    scss(styles),
    __metadata("design:paramtypes", [])
], IdsMenuButton);
export default IdsMenuButton;
//# sourceMappingURL=ids-menu-button.js.map