...
import { TYPES, SIZES, TEXT_ALIGN, } from './ids-input-attributes';
 ...
 */
let IdsInput = class IdsInput extends Base {
    generatedId = '';
    ...
    template() {
        ...
        const { ariaLabel, capsLock, containerClass, inputClass, inputState, labelHtml, placeholder, showHide, type, value } = this.templateVariables();
    ...
    get active() { return stringToBool(this.hasAttribute(attributes.ACTIVE)); }
    /**
    ...
    get bgTransparent() { return stringToBool(this.getAttribute(attributes.BG_TRANSPARENT)); }
    /**
    ...
    get textEllipsis() { return stringToBool(this.getAttribute(attributes.TEXT_ELLIPSIS)); }
    /**
    ...
    get textAlign() {
        return this.getAttribute(attributes.TEXT_ALIGN) || TEXT_ALIGN.default;
    }
    /**
     * Sets the input type
    ...
    get type() {
        return this.getAttribute(attributes.TYPE) ?? TYPES.default;
    }
    /**
...
//# sourceMappingURL=ids-input.js.map