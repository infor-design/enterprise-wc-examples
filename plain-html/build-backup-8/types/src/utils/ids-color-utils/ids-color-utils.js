 ...
 */
export function builtinToRgba(colorName, opacity) {
 ...
 */
export function convertColorToRgba(colorName, opacity) {
 ...
 */
export function convertStatusToIDSColor(statusName) {
    let cssVariable;
    const statuses = [
        'base',
        'error',
...
//# sourceMappingURL=ids-color-utils.js.map