...
describe('IdsDropdown Component', () => {
    ...
    beforeEach(async () => {
        dropdown = createFromTemplate(`<ids-dropdown id="dropdown-1" label="Normal Dropdown" value="opt2" dirty-tracker="true">
      <ids-list-box>
    ...
    it('fixes itself with an empty container', () => {
        dropdown = createFromTemplate(`<ids-dropdown id="dropdown-1" label="Normal Dropdown">
       </ids-dropdown>`);
...
//# sourceMappingURL=ids-dropdown-func-test.js.map