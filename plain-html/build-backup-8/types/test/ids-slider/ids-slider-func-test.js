...
const HTMLSnippets = {
    SINGLE_SLIDER: (`<ids-slider type="single" min="0" max="100" label="Single"></ids-slider>`),
    RANGE_SLIDER: (`<ids-container><ids-slider type="range" min="0" max="100" label="Range Minimum" label-secondary="Range Maximum"></ids-slider><ids-container>`),
    STEP_SLIDER: (`<ids-slider type="step" step-number="5" min="0" max="100" label="Single Step"></ids-slider>`),
    VERTICAL_RANGE_SLIDER: (`<ids-slider type="range" vertical='' min="0" max="100" label="Range Minimum" label-secondary="Range Maximum"></ids-slider>`),
    VERTICAL_STEP_SLIDER: (`<ids-slider type="step" vertical='' step-number="5" min="0" max="100" label="Single Step"></ids-slider>`),
    LANGUAGE_SLIDER: (`<ids-container language="en"><ids-slider></ids-slider></ids-container>`),
};
describe('IdsSlider Component', () => {
    ...
    it('drags correctly on range slider', async () => {
        ...
        label.click();
        slider.thumbDraggableSecondary.dispatchEvent(createEvent('ids-dragstart', { detail: { mouseX: 80, mouseY: 12 } }));
        slider.thumbDraggableSecondary.dispatchEvent(createEvent('ids-drag', { detail: { mouseX: 80, mouseY: 12 } }));
        slider.thumbDraggableSecondary.dispatchEvent(createEvent('ids-dragend', { detail: { mouseX: 80, mouseY: 12 } }));
        slider.thumbDraggable.dispatchEvent(createEvent('ids-dragstart', { detail: { mouseX: 80, mouseY: 12 } }));
        slider.thumbDraggable.dispatchEvent(createEvent('ids-drag', { detail: { mouseX: 80, mouseY: 12 } }));
        slider.thumbDraggable.dispatchEvent(createEvent('ids-dragend', { detail: { mouseX: 80, mouseY: 12 } }));
    });
...
//# sourceMappingURL=ids-slider-func-test.js.map