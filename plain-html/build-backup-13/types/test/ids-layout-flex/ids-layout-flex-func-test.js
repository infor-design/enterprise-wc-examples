...
describe('IdsLayoutFlex Component', () => {
    ...
    let flexItemEl;
    beforeEach(async () => {
        const flex = new IdsLayoutFlex();
        const item1 = new IdsLayoutFlexItem();
        const item2 = new IdsLayoutFlexItem();
        const item3 = new IdsLayoutFlexItem();
...
//# sourceMappingURL=ids-layout-flex-func-test.js.map