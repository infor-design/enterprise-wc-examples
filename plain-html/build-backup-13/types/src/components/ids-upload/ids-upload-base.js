...
const Base = IdsThemeMixin(IdsLabelStateParentMixin(IdsDirtyTrackerMixin(IdsLocaleMixin(IdsFieldHeightMixin(IdsValidationInputMixin(IdsColorVariantMixin(IdsTooltipMixin(IdsEventsMixin(IdsElement)))))))));
export default Base;
//# sourceMappingURL=ids-upload-base.js.map