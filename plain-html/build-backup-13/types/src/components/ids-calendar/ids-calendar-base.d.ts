...
declare const Base: {
    ...
    new (...args: any[]): {
        ...
        onEventsChange?(data: import("./ids-calendar-event").CalendarEventData[]): void;
        onEventTypesChange?(data: import("./ids-calendar-event").CalendarEventTypeData[]): void;
    ...
    new (...args: any[]): {
        "__#104@#eventsData": import("./ids-calendar-event").CalendarEventData[];
        "__#104@#eventTypesData": import("./ids-calendar-event").CalendarEventTypeData[];
        eventsData: import("./ids-calendar-event").CalendarEventData[];
        eventTypesData: import("./ids-calendar-event").CalendarEventTypeData[];
        beforeEventsRender: ((startDate: Date, endDate: Date) => Promise<import("./ids-calendar-event").CalendarEventData[]>) | null;
        viewPicker: boolean;
        onHiddenChange(value: string | boolean): void;
        sortEventsByDate(data: import("./ids-calendar-event").CalendarEventData[]): import("./ids-calendar-event").CalendarEventData[];
        ...
        getEventById(id: string): import("./ids-calendar-event").CalendarEventData | undefined;
        getEventElemById(id: string): import("./ids-calendar-event").default | null | undefined;
        getEventTypeById(id: string | null): import("./ids-calendar-event").CalendarEventTypeData | undefined;
...
export default Base;
//# sourceMappingURL=ids-calendar-base.d.ts.map