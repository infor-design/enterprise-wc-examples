...
const Base = IdsThemeMixin(IdsDirtyTrackerMixin(IdsLabelStateParentMixin(IdsFieldHeightMixin(IdsColorVariantMixin(IdsValidationInputMixin(IdsMonthViewAttributeMixin(IdsDateAttributeMixin(IdsLocaleMixin(IdsKeyboardMixin(IdsEventsMixin(IdsElement)))))))))));
export default Base;
//# sourceMappingURL=ids-date-picker-base.js.map