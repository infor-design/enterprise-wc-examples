...
describe('IdsMultiselect Component', () => {
    ...
    beforeEach(async () => {
        multiselect = createFromTemplate(`<ids-multiselect id="multiselect-1" label="Normal Multiselect" dirty-tracker="true">
        <ids-list-box>
    ...
    it('should handle overflowed text', async () => {
        multiselect = createFromTemplate(`<ids-multiselect label="Overflow text multiselect">
        <ids-list-box>
...
//# sourceMappingURL=ids-multiselect-func-test.js.map