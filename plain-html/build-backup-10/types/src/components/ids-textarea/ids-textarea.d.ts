...
export default class IdsTextarea extends Base {
     ...
     * @returns {void}
     */
    adjustHeight(oldHeight: number, maxHeight: number, input?: HTMLElement | null): void;
    /**
    ...
    get autogrowMaxHeight(): string | null;
    /**
