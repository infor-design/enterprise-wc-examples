 ...
 */
let IdsLookup = class IdsLookup extends Base {
    triggerField;
    triggerButton;
    dataGrid;
    modal;
    ...
    get data() { return this.dataGrid ? this.dataGrid.data : []; }
    /**
    ...
    set size(value) {
        ...
        if (this.triggerField)
            this.triggerField.setAttribute(attributes.SIZE, this.size);
    }
    ...
    get clearable() { return this.state.clearable; }
    /**
...
IdsLookup = __decorate([
    customElement('ids-lookup'),
    scss(styles),
    __metadata("design:paramtypes", [])
], IdsLookup);
export default IdsLookup;
//# sourceMappingURL=ids-lookup.js.map