...
declare const Base: {
    ...
    new (...args: any[]): {
        ...
        "__#22@#refreshLabelState"(oldVariantName: import("../../mixins/ids-label-state-mixin/ids-label-state-common").IdsLabelStateMode, newVariantName: import("../../mixins/ids-label-state-mixin/ids-label-state-common").IdsLabelStateMode): void;
        "__#22@#setlabelState"(doHide?: import("../../mixins/ids-label-state-mixin/ids-label-state-common").IdsLabelStateMode): void;
        "__#22@#hideLabel"(): void;
        "__#22@#showLabel"(): void;
    ...
    new (...args: any[]): {
        ...
        displayMatches(): void;
        "__#23@#populateListBox"(): void;
        "__#23@#templatelistBoxOption"(value: string | null, label: string | null): string;
        "__#23@#addAria"(): object;
        closePopup(): void;
        openPopup(): void;
        ...
        "__#23@#configurePopup"(): void;
        "__#23@#attachEventListeners"(): void;
        "__#23@#attachKeyboardListeners"(): void;
        "__#23@#removeEventListeners"(): void;
    ...
    new (...args: any[]): {
        ...
        "__#20@#initClearableButton"(): HTMLElement;
...
export default Base;
//# sourceMappingURL=ids-input-base.d.ts.map