...
class MaskAPI {
    ...
    conformToMask(rawValue, maskObj, settings) {
        ...
        conformSettings.placeholder = this.convertMaskToPlaceholder(maskObj.mask, conformSettings.placeholderChar);
        ...
        placeholderLoop: for (let l = 0; l < placeholderLength; l++) {
                ...
                if (rawValueArr.length > 0) {
                    ...
                    while (rawValueArr.length > 0) {
                        ...
                        if (rawValueChar.char === placeholderChar && suppressGuide !== true) {
                            ...
                            if (conformSettings.keepCharacterPositions !== true
    ...
    adjustCaretPosition(opts) {
        ...
        // positioning.
        const possiblyHasRejectedChar = isAddition && (opts.previousMaskResult === opts.conformedValue
        ...
        if (possiblyHasRejectedChar) {
            ...
            const targetIsMaskMovingLeft = (opts.previousPlaceholder[intersection.length - 1] !== undefined
...
//# sourceMappingURL=ids-mask-api.js.map