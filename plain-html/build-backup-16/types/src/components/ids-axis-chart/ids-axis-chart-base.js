...
const Base = IdsChartLegendMixin(IdsChartSelectionMixin(IdsThemeMixin(IdsLocaleMixin(IdsEventsMixin(IdsElement)))));
export default Base;
//# sourceMappingURL=ids-axis-chart-base.js.map