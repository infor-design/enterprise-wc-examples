...
describe('IdsImage Component (round and statuses)', () => {
    let component;
    beforeEach(async () => {
        document.body.insertAdjacentHTML('beforeend', `<ids-image src="${src}" alt="${alt}" round="true" user-status="available"></ids-image>`);
        component = document.querySelector(name);
    });
    afterEach(async () => {
        document.body.innerHTML = '';
    ...
    it('should render initials and back to placeholder', () => {
        document.body.innerHTML = '';
        document.body.insertAdjacentHTML('beforeend', `<ids-image round="true" initials="long"></ids-image>`);
        component = document.querySelector(name);
...
//# sourceMappingURL=ids-image-func-test.js.map