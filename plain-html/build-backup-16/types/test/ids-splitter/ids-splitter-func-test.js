...
describe('IdsSplitter Component', () => {
    ...
    it('should check if can save position to local storage', async () => {
      ...
      <ids-splitter unique-id="${uniqueId}" save-position>
        ...
        expect(JSON.parse(localStorage.getItem(splitter.idTobeUse(uniqueId)) || '')).toEqual(expect.objectContaining({
    ...
    it('should clear saved position', async () => {
      ...
      <ids-splitter id="test-splitter-2" unique-id="${uniqueId2}" save-position>
        ...
        dispatchEvent(new Event('load'));
        await processAnimFrame();
        const splitter1 = document.querySelector('#test-splitter-1');
        ...
        expect(JSON.parse(localStorage.getItem(splitter1.idTobeUse(uniqueId1)) || '')).toEqual(expect.objectContaining({
            sizes: expect.arrayContaining([0, 100])
        }));
        const splitter2 = document.querySelector('#test-splitter-2');
        ...
        expect(JSON.parse(localStorage.getItem(splitter2.idTobeUse(uniqueId2)) || '')).toEqual(expect.objectContaining({
            sizes: expect.arrayContaining([0, 100])
        }));
...
//# sourceMappingURL=ids-splitter-func-test.js.map