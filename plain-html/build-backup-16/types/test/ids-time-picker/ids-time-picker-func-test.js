...
describe('IdsTimePicker Component', () => {
    ...
    it('render via document.createElement (append late)', () => {
        const errors = jest.spyOn(global.console, 'error');
        const elem = document.createElement('ids-time-picker');
        elem.format = 'hh:mm';
        elem.value = '12:00';
    ...
    it('should handle locale time format', async () => {
        ...
        await document.querySelector('ids-container')?.setLocale('es-419');
    ...
    `);
        const embeddableTimePicker = document.querySelector('#embeddable');
    ...
    it('can validate/enforce required', () => {
        ...
        timepicker.input.addEventListener('validate', (e) => {
...
//# sourceMappingURL=ids-time-picker-func-test.js.map