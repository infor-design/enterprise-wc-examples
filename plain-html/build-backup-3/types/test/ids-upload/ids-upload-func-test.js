...
describe('IdsUpload Component', () => {
    ...
    it('should drag drop', () => {
        ...
        upload.textInput.dispatchEvent(createBubbledEvent('dragenter', { clientX: 0, clientY: 0 }));
        expect(zIndex()).toEqual('1');
        upload.textInput.dispatchEvent(createBubbledEvent('drop', { clientX: 0, clientY: 1 }));
...
//# sourceMappingURL=ids-upload-func-test.js.map