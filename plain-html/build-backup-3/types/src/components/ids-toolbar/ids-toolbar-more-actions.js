 ...
 */
let IdsToolbarMoreActions = class IdsToolbarMoreActions extends Base {
    constructor() {
        super();
    }
     ...
     */
    get menu() {
        return this.shadowRoot?.querySelector('ids-popup-menu') || null;
    }
    /**
     * @readonly
