...
describe('IdsTimePickerPopup Component', () => {
    ...
    beforeEach(async () => {
        ...
        const element = new IdsTimePickerPopup();
    ...
    it('renders minutes intervals', () => {
        ...
        const getOptions = (id) => Array.from(timepickerPopup.container.querySelector(id)?.options)
...
//# sourceMappingURL=ids-time-picker-popup-func-test.js.map