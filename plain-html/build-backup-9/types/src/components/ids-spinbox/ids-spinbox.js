 ...
 */
let IdsSpinbox = class IdsSpinbox extends Base {
    constructor() {
        super();
    }
    ...
    template() {
        ...
        return (`<div id="ids-spinbox" class="ids-spinbox ids-trigger-field ${containerClass}" part="container">
        ${labelHtml}
    ...
    #attachEventHandlers() {
        ...
        this.onEvent('mousedown.increment', this.incrementButton, this.#getStepButtonCycler('up'));
        this.onEvent('mousedown.decrement', this.decrementButton, this.#getStepButtonCycler('down'));
        ...
        this.listen(['ArrowUp', 'ArrowDown'], this, (e) => {
            if (stringToBool(this.getAttribute(attributes.DISABLED))) {
                return;
            }
            const key = e.key;
            this.#onStepButtonUnpressed();
            ...
            if (MOUSE_LEFT & e.buttons) {
                ...
                const timedLogic = () => {
                    if (this.#stepDirection === direction) {
                        ...
                        tickCounter++;
                        this.#stepCycleTimeout = setTimeout(timedLogic, Math.max(350 - Math.round(tickCounter * 50), 100));
                    }
                    else {
...
IdsSpinbox = __decorate([
    customElement('ids-spinbox'),
    scss(styles),
    __metadata("design:paramtypes", [])
], IdsSpinbox);
export default IdsSpinbox;
//# sourceMappingURL=ids-spinbox.js.map