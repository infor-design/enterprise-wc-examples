 ...
 */
let IdsAccordionHeader = class IdsAccordionHeader extends Base {
    constructor() {
        super();
    }
    connectedCallback() {
    ...
    #refreshIconDisplay(val) {
        ...
        const iconElem = this.container?.querySelector('.ids-accordion-display-icon');
        if (iconElem) {
...
IdsAccordionHeader = __decorate([
    customElement('ids-accordion-header'),
    scss(styles),
    __metadata("design:paramtypes", [])
], IdsAccordionHeader);
export default IdsAccordionHeader;
//# sourceMappingURL=ids-accordion-header.js.map