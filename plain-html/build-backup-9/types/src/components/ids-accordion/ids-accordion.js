 ...
 */
let IdsAccordion = class IdsAccordion extends Base {
    header = null;
    constructor() {
        super();
    }
     ...
     */
    #assignDepthDependentStyles(element = this, depth = 0, doColorVariant = true, doExpanderType = true, doDisplayIconType = true, doRTL = true) {
        ...
        for (const childEl of children) {
            ...
            this.#assignDepthDependentStyles(childEl, depth + 1, doColorVariant, doExpanderType, doDisplayIconType, doRTL);
        }
    }
    /**
     * @returns {void}
