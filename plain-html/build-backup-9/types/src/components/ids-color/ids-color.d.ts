...
declare const Base: {
    ...
    new (...args: any[]): {
        ...
        disconnectedCallback(): void;
        onEvent(eventName: string, target: any, callback?: ((evt: any) => void) | undefined, options?: import("../../mixins/ids-events-mixin/ids-events-mixin").EventOptions | undefined): void; /** @param {string} value Text for this color swatch's tooltip */
...
declare const SwatchSizes: readonly ["xs", "sm", "mm", "md", "lg"];
