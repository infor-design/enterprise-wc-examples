...
const Base = IdsMonthViewAttributeMixin(IdsDateAttributeMixin(IdsCalendarEventsMixin(IdsThemeMixin(IdsLocaleMixin(IdsEventsMixin(IdsElement))))));
export default Base;
//# sourceMappingURL=ids-month-view-base.js.map