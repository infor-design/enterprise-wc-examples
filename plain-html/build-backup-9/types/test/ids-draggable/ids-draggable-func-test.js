...
describe('IdsDraggable Component', () => {
    ...
    it('renders with no errors', async () => {
        ...
        await createFromTemplate(draggable, `<ids-draggable>
        <div>draggable</div>
      </ids-draggable>`);
        const container = document.createElement('div');
        container.style.width = '640px';
        container.style.height = '480px';
        await createFromTemplate(draggable, `<ids-draggable parent-containment>
        <div>draggable</div>
      </ids-draggable>`);
        await createFromTemplate(draggable, `<ids-draggable axis="x">
        <div>x</div>
      </ids-draggable>`);
        await createFromTemplate(draggable, `<ids-draggable axis="y">
        <div>y</div>
      </ids-draggable>`);
        expect(errors).not.toHaveBeenCalled();
    });
    it('can set/get the axis attribute predictably', async () => {
        const elem = await createFromTemplate(draggable, `<ids-draggable>
        <div>draggable</div>
      </ids-draggable>`);
    ...
    it('can set/get the handle attribute predictably', async () => {
        const elem = await createFromTemplate(draggable, `<ids-draggable handle=".handle">
    ...
    it('begins drag and no errors are thrown', async () => {
        ...
        container.style.width = '640px';
        container.style.height = '480px';
        const elem = await createFromTemplate(draggable, `<ids-draggable parent-containment>
        <div>draggable</div>
      </ids-draggable>`);
    ...
    it('sets max-transform-x value predictably', async () => {
        const elem = await createFromTemplate(draggable, `<ids-draggable parent-containment max-transform-x='80'>
        <div>draggable</div>
      </ids-draggable>`);
        await processAnimFrame();
    ...
    it('sets min-transform-x value predictably', async () => {
        const elem = await createFromTemplate(draggable, `<ids-draggable parent-containment min-transform-x='-20'>
        <div>draggable</div>
      </ids-draggable>`);
        await processAnimFrame();
    ...
    it('sets max-transform-y value predictably', async () => {
        const elem = await createFromTemplate(draggable, `<ids-draggable parent-containment max-transform-y='-20'>
        <div>draggable</div>
      </ids-draggable>`);
        await processAnimFrame();
    ...
    it('sets relative-bounds value predictably', async () => {
        const elem = await createFromTemplate(draggable, `<ids-draggable parent-containment relative-bounds='left: -20; right: -20'>
        <div>draggable</div>
      </ids-draggable>`);
        await processAnimFrame();
    ...
    it('sets min-transform-y value predictably', async () => {
        const elem = await createFromTemplate(draggable, `<ids-draggable parent-containment min-transform-y='-20'>
        <div>draggable</div>
      </ids-draggable>`);
        await processAnimFrame();
...
//# sourceMappingURL=ids-draggable-func-test.js.map