...
describe('Ids Step Chart Tests', () => {
    ...
    beforeEach(async () => {
        elem = await createElemViaTemplate(`<ids-step-chart label="2 of 7 steps completed" color="azure08" step-number="7" value="3" completed-label="5 days overdue" progress-color="ruby03"></ids-step-chart>`);
...
//# sourceMappingURL=ids-step-chart-func-test.js.map