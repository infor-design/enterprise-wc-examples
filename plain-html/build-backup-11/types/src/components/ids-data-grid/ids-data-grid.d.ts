...
import { IdsDataGridContextmenuArgs } from './ids-data-grid-contextmenu';
import { IdsDataGridColumn } from './ids-data-grid-column';
import IdsPopupMenu from '../ids-popup-menu/ids-popup-menu';
import { IdsDataGridEmptyMessageElements } from './ids-data-grid-empty-message';
...
declare const Base: {
    ...
    new (...args: any[]): {
        ...
        "__#132@#valSettings": string[];
        "__#132@#saveMode": boolean;
        "__#132@#restored": string[];
        saveActivePage: boolean;
        saveColumns: boolean;
        saveFilter: boolean;
        savePageSize: boolean;
        saveRowHeight: boolean;
        saveSortOrder: boolean;
        saveUserSettings: boolean;
        "__#132@#setBoolAttribute"(attributeName: string, value: string | boolean): void;
        "__#132@#canUseLocalStorage"(): boolean;
        "__#132@#keyTobeUsed"(setting: string, prefix?: string, suffix?: string, uniqueId?: string): string;
        "__#132@#keyAndValue"(setting: string): {
            key: string;
            value: any;
        };
        "__#132@#save"(key: string, value: any): void;
        saveSetting(setting: string): void;
        saveAllSettings(): void;
        savedSetting(setting: string): any;
        allSavedSettings(): import("./ids-data-grid-save-settings-mixin").IdsDataGridSaveSettings;
        clearSetting(setting: string, key?: string | undefined): void;
        clearAllSettings(userKeys?: any): void;
        restoreSetting(setting: string, value?: any): void;
        restoreAllSettings(userSettings?: import("./ids-data-grid-save-settings-mixin").IdsDataGridSaveSettings): void;
        "__#132@#restoreUserSetting"(setting: string, value: any, callback: () => void): void;
        "__#132@#restoreActivePage"(value?: any): void;
        /**
         * Check if row is selected.
         * @param {number} index The row index
         * @returns {boolean} True, if row is selected
         */
        "__#132@#restoreColumns"(value?: any): void;
        "__#132@#restoreFilter"(value?: any): void;
        "__#132@#restorePageSize"(value?: any): void;
        "__#132@#restoreRowHeight"(value?: any): void;
        "__#132@#restoreSortOrder"(value?: any): void;
        saveSettings(): void;
    ...
    new (...args: any[]): {
        ...
        setupTooltip(): void;
        "__#133@#handleTooltip"(e: MouseEvent): Promise<void>;
        "__#133@#tooltipBodyCell"(path: HTMLElement[]): Promise<void>;
        "__#133@#tooltipHeaderTitleOrIcon"(path: HTMLElement[]): Promise<void>;
        "__#133@#tooltipFilterButton"(path: HTMLElement[]): Promise<void>;
        "__#133@#setTooltipCssPart"(opt: any): Promise<void>;
        "__#133@#tooltipContent"(opt: any): Promise<string>;
        "__#133@#tooltipOptions"(opt: any): Promise<import("./ids-data-grid-column").IdsDataGridTooltipOptions>;
        "__#133@#showTooltip"(opt: any): void;
        "__#133@#hideTooltip"(): void;
        "__#133@#mouseOut": boolean;
        "__#133@#attachTooltip"(): void;
        /**
         * Handle Locale (and language) change
         */
        "__#133@#detachTooltip"(): void;
        onEvent(eventName: string, target?: any, callback?: ((evt: any) => void) | undefined, options?: import("../../mixins/ids-events-mixin/ids-events-mixin").EventOptions | undefined): void;
        offEvent(eventName: string, target?: any, options?: import("../../mixins/ids-events-mixin/ids-events-mixin").EventOptions | undefined): void;
        triggerEvent(eventName: string, target: any, options?: CustomEventInit<any> | undefined): void;
        triggerVetoableEvent(eventType: string, data?: any): boolean;
...
export default class IdsDataGrid extends Base {
    ...
    get body(): HTMLElement | null | undefined;
    get rows(): HTMLElement[];
    get wrapper(): HTMLElement | null | undefined;
    connectedCallback(): void;
    /** Reference to datasource API */
    readonly datasource: IdsDataSource;
    /** Filters instance attached to component  */
    readonly filters: IdsDataGridFilters;
    /** API for list of formatters */
    readonly formatters: IdsDataGridFormatters;
    /** API for list of editors */
    readonly editors: {
        type: string;
        editor?: import("./ids-data-grid-editors").IdsDataGridEditor | undefined;
    }[];
    /**
     ...
     * @returns {void}
     */
    applyFilter(conditions: Array<IdsDataGridFilterConditions>): void;
    /**
     ...
     */
    columnGroupDataById(columnGroupId: string): any;
    /**
     ...
     */
    columnDataById(columnId: string): IdsDataGridColumn;
    /**
     ...
     * @param {Array} value The array to use
     */
    appendData(value: Array<Record<string, any>>): void;
    /**
     ...
     */
    set headerMenuId(value: string | null);
    get headerMenuId(): string | null;
    /**
     * Set the header menu data
     * @param {Array} value The array to use
     */
    set headerMenuData(value: any);
    get headerMenuData(): any;
    /**
     * Set menu id
     * @param {string} value The menu id
     */
    set menuId(value: string | null);
    ...
    requestAnimationFrame(fnCallback: () => void): void;
    /**
     ...
     */
    scrollRowIntoView(rowIndex: number, doScroll?: boolean): void;
    /**
     ...
     */
    set listStyle(value: boolean);
    get listStyle(): boolean;
    /**
     * Set the row selection mode between false, 'single', 'multiple' and 'mixed'
     * @param {string|boolean} value selection mode to use
     */
    set rowSelection(value: string | boolean);
    get rowSelection(): string | false;
    /**
    ...
    set suppressRowClickSelection(value: string | boolean);
    get suppressRowClickSelection(): string | false;
    /**
     ...
     */
    set suppressRowDeselection(value: string | boolean);
    get suppressRowDeselection(): string | false;
    /**
     ...
     * @param {string|boolean} value true or false
     */
    set suppressRowDeactivation(value: string | boolean);
    get suppressRowDeactivation(): string | false;
    /**
     ...
     */
    updateDataset(row: number, data: Record<string, unknown>, isClear?: boolean): void;
    /**
     ...
     */
    addRow(data: Record<string, unknown>, index?: number): void;
    /**
     ...
     */
    addRows(data?: Array<Record<string, unknown>>, index?: number): void;
    /**
     ...
     */
    selectRow(index: number, triggerEvent?: boolean): void;
    /**
     * Set a row to be deselected
     * @param {number} index the zero based index
     * @param {boolean} triggerEvent fire an event with the deselected row
     */
    deSelectRow(index: number, triggerEvent?: boolean): void;
    /**
     ...
     */
    setActiveCell(cellNumber: number, rowIndex: number, noFocus?: boolean): Record<string, any>;
    /**
     * Sets disable client filter
     * @param {boolean|string} value IThe value
     */
    set disableClientFilter(value: boolean);
     ...
     */
    set filterRowDisabled(value: boolean);
    get filterRowDisabled(): boolean;
    /**
     * Sets the data grid to filter when typing
     * @param {boolean|string} value The value
     */
    set filterWhenTyping(value: boolean);
    get filterWhenTyping(): boolean;
    /**
     * Sets the grid to render as a tree grid (does require a tree formatter column)
     * @param {boolean|string} value The value
     */
    set treeGrid(value: boolean);
     ...
     * @param {string} value The value
     */
    set expandableRow(value: string | boolean);
    get expandableRow(): string | false;
    /**
     ...
     * @param {string} value The value
     */
    set expandableRowTemplate(value: string);
    get expandableRowTemplate(): string;
    /**
     ...
     */
    exportToExcel(format: 'csv' | 'xlsx', filename: string, keepGridFormatting?: boolean): void;
    /**
