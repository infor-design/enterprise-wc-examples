 ...
 */
let IdsPagerInput = class IdsPagerInput extends Base {
    ...
    template() {
        ...
        return (`<ids-text ${idsTextAttribs}>Page</ids-text>&nbsp;
      <ids-input
    ...
    set pageNumber(value) {
        ...
        if (Number.isNaN(currentVal) || val === currentVal)
            return;
        if (inputHost) {
...
IdsPagerInput = __decorate([
    customElement('ids-pager-input'),
    scss(styles),
    __metadata("design:paramtypes", [])
], IdsPagerInput);
export default IdsPagerInput;
//# sourceMappingURL=ids-pager-input.js.map