...
const checkTooltip = async (elem, grid, tooltipEl, shouldSetWidth = false) => {
...
describe('IdsDataGrid Component', () => {
    ...
    it.skip('should veto before tooltip show response', async () => {
        let isVeto;
        dataGrid.addEventListener('beforetooltipshow', (e) => {
...
//# sourceMappingURL=ids-data-grid-func-tooltip-test.js.map