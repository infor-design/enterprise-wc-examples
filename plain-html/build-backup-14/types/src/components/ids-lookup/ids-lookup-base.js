...
const Base = IdsDirtyTrackerMixin(IdsLabelStateParentMixin(IdsLocaleMixin(IdsKeyboardMixin(IdsValidationInputMixin(IdsFieldHeightMixin(IdsTooltipMixin(IdsThemeMixin(IdsEventsMixin(IdsElement)))))))));
export default Base;
//# sourceMappingURL=ids-lookup-base.js.map