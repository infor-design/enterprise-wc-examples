 ...
 */
let IdsColorPicker = class IdsColorPicker extends Base {
    constructor() {
        super();
    }
    colorInput;
     ...
     */
    #fieldSwatchSize() {
        const fieldHeight = this.compact ? 'mm' : this.fieldHeight;
    ...
    get defaultSwatches() {
        ...
        return [
            ...
            color.hex = getComputedStyle(this.parentElement).getPropertyValue(String(cssVarName)) || `var(${cssVarName})`;
    ...
    appendClearableButton() {
        const noColorSwatch = this.swatches.find((e) => !e.getAttribute(attributes.HEX));
        if (!noColorSwatch) {
    ...
    #attachEventHandlers() {
        ...
        this.onEvent('click.color-picker-container', this.container, (event) => {
        ...
        this.onEvent('input.color-picker-text', this.textInput, (e) => {
            this.#updateColor(e.target.value);
        });
        if (this.advanced) {
            this.#attachColorInputEventHandlers();
        }
        this.onEvent('keydown.color-picker', this, (e) => {
        ...
        this.onEvent('keydown.color-picker-popup', this.popup, (e) => {
    ...
    #attachColorInputEventHandlers() {
        // Respond to change events from the swatch input
        this.offEvent('input.color-picker-input', this.colorInput);
        this.onEvent('input.color-picker-input', this.colorInput, (e) => {
            this.#updateColor(e.target.value);
        });
    }
    #detachColorInputEventHandlers() {
        this.offEvent('input.color-picker-input', this.colorInput);
    }
...
IdsColorPicker = __decorate([
    customElement('ids-color-picker'),
    scss(styles),
    __metadata("design:paramtypes", [])
], IdsColorPicker);
export default IdsColorPicker;
//# sourceMappingURL=ids-color-picker.js.map