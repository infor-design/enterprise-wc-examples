...
export default class IdsMenuItem extends Base {
     ...
     */
    template(): string;
    templateCheck(): string;
    templateDisplayIcon(icon: string): string;
    templateShortcutKeys(shortcutText: string): string;
    templateSubmenuIcon(): string;
    /**
     ...
     */
    get a(): HTMLAnchorElement | null | undefined;
    /**
     * @readonly
