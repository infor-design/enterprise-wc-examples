<script>
	...
	import { default as IdsButtonIndexExample } from './examples/ids-button/Index.svelte';
	import { default as IdsModalIndexExample } from './examples/ids-modal/Index.svelte';
</script>
